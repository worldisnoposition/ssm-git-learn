...
class Solution {
    public List<List<Integer>> permute(int[] nums) {
        ...
        help(nums, new ArrayList<>(), new boolean[nums.length], res);
        return res;
    }

    public void help(int [] nums, List<Integer> temp, boolean [] used, List<List<Integer>> res){
