...
//        dataSourceMap.put("db1", createDataSource("db1"));
        ...
        TableRule orderTableRule = TableRule.builder("job_detail")
                .actualTables(Arrays.asList("job_detail_01", "job_detail_02"))
...
//                .databaseShardingStrategy(new DatabaseShardingStrategy("user_id", new ModuleDatabaseShardingAlgorithm()))
                .tableShardingStrategy(new TableShardingStrategy("job_id", new ModuleTableShardingAlgorithm())).build();
